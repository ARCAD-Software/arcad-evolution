...
/**
 * ATTENTION : cette classe est une copie de la classe Delete.jave de la version
 * 1.7 de Ant.
 * La port‚e de la m‚thode {@link #delete(File) delete} a ‚t‚ chang‚e de 
 * private en protected.<br>
 * Des m‚thodes d'accŠs sp‚cifiques ont ‚t‚ ajout‚e 
 * 
 * @author md
 *
 */
...
//	************************************************************************
    ...
    /*
     * Ajout de m‚thode d'accŠs 
     * 
     */
	public static int getDELETE_RETRY_SLEEP_MILLIS() {
