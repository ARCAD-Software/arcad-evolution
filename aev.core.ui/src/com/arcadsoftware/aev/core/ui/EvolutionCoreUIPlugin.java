...
public class EvolutionCoreUIPlugin extends ArcadPlugin implements IHelperRessource {
	...
	public final static String ICO_CLM_ADD = "clm/Add.gif"; //$NON-NLS-1$
	public final static String ICO_CLM_ADD_ALL = "clm/AddAll.gif";//$NON-NLS-1$
	public final static String ICO_CLM_REMOVE = "clm/Remove.gif";//$NON-NLS-1$
	public final static String ICO_CLM_REMOVE_ALL = "clm/RemoveAll.gif";//$NON-NLS-1$
	...
	public static final String ACT_PROPERTIES = "properties.gif"; //$NON-NLS-1$
	public static final String ACT_SORT = "sort.gif"; //$NON-NLS-1$
	public static final String ACT_PREFS = "prefs.gif"; //$NON-NLS-1$
	public static final String ACT_SEARCH = "search.gif"; //$NON-NLS-1$
	public static final String ACT_FILTER = "filter.gif"; //$NON-NLS-1$
	public static final String ACT_FIND = "act_find.gif"; //$NON-NLS-1$
	public static final String ACT_EXPORT = "clm/ExportData.gif"; //$NON-NLS-1$
