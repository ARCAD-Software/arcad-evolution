...
public class TabbedPropertySheetPage
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7274446818089980428L;
	...
	class TabbedPropertySheetPageLabelProvider
		 ...
		 * 
		 */
		private static final long serialVersionUID = -418655948833538996L;
	...
	public TabbedPropertySheetPage(
		...
		tabSelectionListeners = new ArrayList<ITabSelectionListener>();
...
//		widgetFactory.paintBordersFor(tabbedPropertyComposite);
		...
		tabbedPropertyComposite.getScrolledComposite().addControlListener(
				new ControlAdapter() {
					 ...
					 * 
					 */
					private static final long serialVersionUID = 4317623645413162359L;
...
//		}
	...
	protected void updateTabs(ITabDescriptor[] descriptors) {
		Map<ITabDescriptor, TabContents> newTabs = new HashMap<ITabDescriptor, TabContents>(descriptors.length * 2);
