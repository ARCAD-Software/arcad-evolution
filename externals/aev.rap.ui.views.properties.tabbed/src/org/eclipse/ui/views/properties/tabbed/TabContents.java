    ...
    public void createControls(Composite parent,
        ...
        for (int i = 0; i < sections.length; i++) {
            ...
            ISafeRunnable runnable = new SafeRunnable() {
				 ...
				 * 
				 */
				private static final long serialVersionUID = -4593546319493417790L;
    ...
    public void dispose() {
        for (int i = 0; i < sections.length; i++) {
            ...
            ISafeRunnable runnable = new SafeRunnable() {
				 ...
				 * 
				 */
				private static final long serialVersionUID = -4582765766795862584L;
    ...
    public void aboutToBeShown() {
        for (int i = 0; i < sections.length; i++) {
            ...
            ISafeRunnable runnable = new SafeRunnable() {
				 ...
				 * 
				 */
				private static final long serialVersionUID = 7198082716383977635L;
    ...
    public void aboutToBeHidden() {
        for (int i = 0; i < sections.length; i++) {
            ...
            ISafeRunnable runnable = new SafeRunnable() {
				 ...
				 * 
				 */
				private static final long serialVersionUID = -4048849975214501205L;
    ...
    public void setInput(final IWorkbenchPart part, final ISelection selection) {
        for (int i = 0; i < sections.length; i++) {
            ...
            ISafeRunnable runnable = new SafeRunnable() {
				 ...
				 * 
				 */
				private static final long serialVersionUID = -2693693134370939493L;
        ...
        if (controlsCreated) {
            for (int i = 0; i < sections.length; i++) {
                ...
                ISafeRunnable runnable = new SafeRunnable() {
					 ...
					 * 
					 */
					private static final long serialVersionUID = 3802743396869557881L;
