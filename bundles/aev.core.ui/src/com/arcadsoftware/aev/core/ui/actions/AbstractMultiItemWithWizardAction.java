 ...
 * Cette classe prend en charge l'appel à un assistant de saisie des données
 * utilisateur nécessaires au paramétrage de l'exécution de la commande.
 * 
 * @author MD
 */
public abstract class AbstractMultiItemWithWizardAction extends AbstractMultiItemAction {
	 ...
	 */
	public AbstractMultiItemWithWizardAction(ArcadActions containerActions) {
	 ...
	 */
	public AbstractMultiItemWithWizardAction(IArcadCollectionProvider collectionProvider) {
	 ...
	 * @param entity
	 */
	public AbstractMultiItemWithWizardAction(ArcadEntity entity) {
		super(entity);
	}
	 ...
	 * @param collection
	 */
	public AbstractMultiItemWithWizardAction(ArcadCollection collection) {
		super(collection);
	}
	 ...
	 *         {@link com.arcadsoftware.core.ui.wizards.AbstractMultiItemWizard
	 *         AbstractMultiItemWizard}
	 */
	 ...
	 * l'action, y compris l'affichage d'un assistant. Lors de circonstances
	 * particulières ou en fonction de paramétres particuliers vous désirez ne
	 * pas faire l'appel à l'assistant de saisie vous devez surcharger la
	 * méthode {@link #useWizard() <code>useWizard()</code>} pour lui faire
	 * renvoyer "false". Dans cas, l'exécution sera la même que pour une
	 * exécution standard.
	 * <p>
