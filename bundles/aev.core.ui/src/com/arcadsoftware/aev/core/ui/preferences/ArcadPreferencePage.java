...
public abstract class ArcadPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	/**
	 * Cr�ation d'une page de pr�f�rences.<br>
	 * A d�river dans un autre plugin que le Core UI Plugin.<br>
	 * Dois affecter le PreferenceStore du plugin consern�.
	 *
	 * @param store
	 *            stockage des propri�t�s � �diter.
	 */
	...
	/**
	 * Ajoute un champ de saisie bool�en.
	 *
	 * @param key
	 * @param label
	 */
	...
	/**
	 * Ajoute un champ de saisie pour un type �num�ration.
	 *
	 * @param key
	 * @param label
	...
	/**
	 * Ajoute un champ de saisie de chaine de caract�re.
	 *
	 * @param key
	 * @param label
	 */
	...
	public void setVisible(final boolean visible) {
		...
		// Permet de mettre � jour la r�f�rence de l'aide directement, d�s
		// que la page est s�lectionn�e.
