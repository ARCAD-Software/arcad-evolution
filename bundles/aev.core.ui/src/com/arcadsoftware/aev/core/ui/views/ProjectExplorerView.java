...
public abstract class ProjectExplorerView extends ArcadTableView implements IPartListener2, IContainerSelectListener {
	...
	private static final int[] defaultContainer = new int[] {
			// Mettre ici les identifiants des container autoris�s
	};
	...
	/**
	 * M�thode permettant de rattacher un ExplorerMementoTools sp�cifique Le DefaultExplorerMementoTools ici ne fait
	 * aucune sauvegarde
	 *
	 * @return
	 */
