...
public class EvolutionCoreUIPlugin extends ArcadUIPlugin implements IHelperImage, IHelperLabel {
	...
	/**
	 * Obtenir la valeur d'une pr�f�rence de type Entier
	 *
	 * @param id
	 *            l'identifiant de la pr�f�rence
	 */
	...
	/**
	 * Obtenir le niveau de d�tail des messages � l'affichage.
	 *
	 * @return int
	 */
	...
	/**
	 * Modifie le niveau de d�taild es messages � l'affichage.
	 *
	 * @param value
	 */
