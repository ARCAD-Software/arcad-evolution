...
public class Test implements IListBrowseListener{
	...
	public void removeDuplicate(AbstractXmlList l ) {
		...
		l.removeDuplicate("");
		long end = System.currentTimeMillis();
		System.out.println("Temps de d‚doublonnage : " + String.valueOf(end-start));
	}	
	...
	public void reinitializeValue(AbstractXmlList l ) {
		...
		long end = System.currentTimeMillis();
		System.out.println("Temps de remise … jour : " + String.valueOf(end-start));
	}	
	...
	public void mergeList(AbstractXmlList l ) {
		long start = System.currentTimeMillis();
		//cas nø1 = Liste resultat <> de L1 et L2 | ctrl existence = false | replacement = false : OK
		//cas nø1 = Liste resultat = L1           | ctrl existence = false | replacement = false : OK
		//cas nø1 = Liste resultat = L2           | ctrl existence = false | replacement = false : OK
		//cas nø1 = Liste resultat <> de L1 et L2 | ctrl existence = true  | replacement = false : OK
		//cas nø1 = Liste resultat = L1           | ctrl existence = true  | replacement = false : OK
		//cas nø1 = Liste resultat = L2           | ctrl existence = true  | replacement = false : OK
		//cas nø1 = Liste resultat <> de L1 et L2 | ctrl existence = true  | replacement = true  : OK
		//cas nø1 = Liste resultat = L1           | ctrl existence = true  | replacement = true  : OK
		//cas nø1 = Liste resultat = L2           | ctrl existence = true  | replacement = true  :
	...
	public void substractList(AbstractXmlList l ) {
		...
		//cas nø1 = Liste resultat = L2           | ctrl existence = false | replacement = false : OK
		//cas nø1 = Liste resultat <> de L1 et L2 | ctrl existence = true  | replacement = false : OK
		//cas nø1 = Liste resultat = L1           | ctrl existence = true  | replacement = false : 
		//cas nø1 = Liste resultat = L2           | ctrl existence = true  | replacement = false : 
		//cas nø1 = Liste resultat <> de L1 et L2 | ctrl existence = true  | replacement = true  : OK
		//cas nø1 = Liste resultat = L1           | ctrl existence = true  | replacement = true  : OK
		//cas nø1 = Liste resultat = L2           | ctrl existence = true  | replacement = true  : OK
	...
	public void intersectList(AbstractXmlList l ) {
		long start = System.currentTimeMillis();
		//cas nø1 = Liste resultat <> de L1 et L2 | ctrl existence = false | replacement = false : OK
		//cas nø1 = Liste resultat = L1           | ctrl existence = false | replacement = false : 
		//cas nø1 = Liste resultat = L2           | ctrl existence = false | replacement = false : OK
		//cas nø1 = Liste resultat <> de L1 et L2 | ctrl existence = true  | replacement = false : OK
		//cas nø1 = Liste resultat = L1           | ctrl existence = true  | replacement = false : 
		//cas nø1 = Liste resultat = L2           | ctrl existence = true  | replacement = false : OK
		//cas nø1 = Liste resultat <> de L1 et L2 | ctrl existence = true  | replacement = true  : OK
		//cas nø1 = Liste resultat = L1           | ctrl existence = true  | replacement = true  : 
		//cas nø1 = Liste resultat = L2           | ctrl existence = true  | replacement = true  : OK
